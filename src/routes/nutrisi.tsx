...
export const campaigns = [
  ...
  },
  {
    ...
    description: "Wamena berada di ketinggian lebih dari 1.600 meter, dengan cuaca dingin yang membuat kebutuhan kalori & protein anak-anak lebih tinggi. SDN 015 Wamena memiliki 35 siswa dari keluarga petani yang seringkali hanya mengandalkan ubi dan sayur kol. Program ini bermitra dengan Petani Lokal Wamena dan Posyandu untuk menyediakan makan siang lengkap selama 10 minggu. Estimasi Rp 18.000/porsi (logistik dataran tinggi) × 35 anak × 5 hari × 10 minggu ≈ Rp 32 juta. Termasuk pengukuran tumbuh kembang siswa di awal dan akhir program.",
    ...
    shares: 203,
    mealPlan: {
      ringkasan: "Menu 5 hari dataran tinggi Wamena — kaya kalori & protein, bahan dari Petani Lokal & dapur Posyandu.",
