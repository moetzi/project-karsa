...
export const campaigns = [
  ...
  },
  {
    ...
    description: "Di daerah pegunungan sekitar Nabire, akses pangan bergizi sangat terbatas karena jarak ke pasar yang jauh dan kondisi jalan yang sulit. SDN 027 Nabire memiliki 28 siswa yang sebagian besar tumbuh kembangnya berada di bawah standar. Bersama Kelompok Wanita Tani Sumber Rejeki dan Posyandu Nabire Timur, kami menyediakan makan siang bergizi setiap hari sekolah: nasi, protein (ikan/ayam), sayur, dan buah lokal. Dana digunakan untuk bahan baku, insentif tim masak, dan logistik pengiriman ke sekolah.",
  ...
  },
  {
    ...
    description: "Wamena berada di ketinggian lebih dari 1.600 meter, dengan cuaca dingin yang membuat kebutuhan gizi anak-anak semakin tinggi. SDN 015 Wamena memiliki 35 siswa dari keluarga petani yang seringkali hanya mengandalkan ubi dan sayur kol. Program ini bermitra dengan Petani Lokal Wamena dan Dinas Pangan untuk menyediakan makan siang lengkap dengan protein hewani, sayur, dan buah. Dana untuk 10 minggu program, termasuk pengukuran tumbuh kembang siswa di awal dan akhir.",
  ...
  },
  {
    ...
    description: "Di pesisir Mamuju, nelayan sering mengalami musim tangkau ikan yang tidak menentu. Akibatnya, asupan protein anak-anak di SDN 008 Mamuju menjadi tidak stabil. Kami bermitra dengan Kelompok Nelayan Maju dan PKK Kecamatan Mamuju untuk memastikan 31 siswa mendapat makan siang bergizi setiap hari sekolah. Menu mengandalkan ikan segar, sayur, dan karbohidrat lokal. Dana untuk satu semester.",
  ...
  },
  {
    ...
    description: "SDN 032 Sorong berada di kawasan transisi kota dan desa, di mana banyak keluarga masih kesulitan menyediakan makanan bergizi setiap hari. Program ini bertujuan memberikan makan siang sehat untuk 26 siswa selama 12 minggu, dengan menu berbasis pangan lokal: sagu, ikan, keladi, dan sayur pesisir. KWT Sorong Raya memasak, Posyandu Sorong Selatan membantu pendampingan gizi.",
